...
#if !defined(SDL_PLATFORM_HAIKU) && !defined(SDL_PLATFORM_PSP) && !defined(SDL_PLATFORM_3DS) && !defined(SDL_PLATFORM_PS2) && !defined(SDL_PLATFORM_DREAMCAST) /* already defined in a system header. */
