...
float xrot = 0.5f, yrot = 0.5f, zrot = 0.5f;
float xspeed = 100.0f, yspeed = 100.0f, zspeed = 100.0f;
const float ROTATION_SPEED = 5000.0f;
...
int main(int argc, char **argv) {
    ...
    // SDL_Joystick *joystick = SDL_OpenJoystick(0); // Open the first joystick
    // if (!joystick) {
    ...
    // HandleJoystickInput(joystick, &xspeed, &yspeed, ROTATION_SPEED);
        ...
        Uint32 frameTime = SDL_GetTicksNS() - currentTime;
